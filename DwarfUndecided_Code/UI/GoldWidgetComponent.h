...
#include "GoldWidgetComponent.generated.h"

UENUM()
enum class EGoldSetTypee
{
 ...
 */
UCLASS()
class COOLGP3PROJECT_API UGoldWidgetComponent : public UWidgetComponent
{
	GENERATED_BODY()

public:
	UGoldWidgetComponent();
...
protected:
	...
	EGoldSetTypee GoldInterpolationType;
...
public:
	...
	static FString GetNumberInGoldFormat(int Value);

	static float InterpByType(int CurrentValue, int PreviousValue, int TargetValue, float Duration, float DeltaTime, EGoldSetTypee InterpType);
};